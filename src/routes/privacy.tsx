...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — Masembe Childcare Foundation Uganda" },
      { name: "description", content: "How Masembe Childcare Foundation Uganda collects, uses and protects your personal data." },
    ],
  }),
  component: () => (
    <SiteLayout>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-6 prose prose-slate space-y-6 text-ink/70 leading-relaxed">
          ...
          <p>Masembe Childcare Foundation Uganda ("we", "us") respects your privacy. This page describes how we collect, use, and protect your personal data.</p>
