...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Use — Masembe Childcare Foundation Uganda" },
      { name: "description", content: "Terms and conditions for using the website of Masembe Childcare Foundation Uganda." },
    ],
  }),
  component: () => (
    <SiteLayout>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-6 space-y-6 text-ink/70 leading-relaxed">
          ...
          <p>All content remains the property of Masembe Childcare Foundation Uganda and may not be reused without permission.</p>
